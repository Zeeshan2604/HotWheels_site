  ...
  const CollectionsSection = () => {
    ...
    return (
      <section className="py-20 bg-black">
        ...
        >
          <h2 className="text-2xl lg:text-3xl font-bold mb-6 lg:mb-8 px-4 text-white">Featured Collections</h2>
            ...
            {collectionsState.map((collection) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end p-6">
                  <div>
                    <h3 className="text-l lg:text-3xl font-bold text-white mb-2">{collection.name}</h3>
                    <Link
                      to={`/collections/${collection._id}`}
                      className="text-sm lg:text-l text-red-500 hover:text-red-400 transition-colors"
                    >
                      Explore Collection →
                    </Link>
                  </div>
  ...
  const LatestProductsSection = () => {
    ...
    return (
      <section className="py-20 bg-zinc-950">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-12 lg:mb-8 px-4 text-center text-white">
            Latest Arrivals
          </h2>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 px-4 overflow-x-auto pb-4 lg:pb-10 text-white">
            {latestProductsState.map((product) => (
              <motion.div
                key={product._id}
                onClick={() => navigate(`/product/${product._id}`)}
                className="w-full group flex-shrink-0 bg-zinc-900 rounded-xl overflow-hidden
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-l lg:text-xl font-bold mb-2 group-hover:text-red-500 transition-colors">
                    {product.name}
                  </h3>
                  <div className="flex justify-between items-center">
                    <span className="text-l lg:text-xl font-bold text-white group-hover:text-red-500 transition-colors">
                      ${product.price}
                    </span>
                    <div className="flex items-center">
                      <button
                        ...
                        className="block lg:hidden p-2 bg-red-500 rounded-full text-white transition-all duration-300 hover:bg-red-600"
                      >
                      ...
                      <button
                        ...
                        className="hidden lg:block px-6 py-2 h-6 w-6 lg:h-auto lg:w-auto bg-red-500 rounded-full text-white transition-all duration-300 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative aspect-square rounded-2xl overflow-hidden group">
              ...
              <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-4 z-20">
                <button 
                  onClick={() => {
                    navigate(`/game/67bb1360b567722f510345dd`);
                  }}
