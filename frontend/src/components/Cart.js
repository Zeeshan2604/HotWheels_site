...
const Cart = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="container mx-auto px-4 py-8 mt-1 flex flex-col lg:flex-row gap-8">
        <div className="w-full lg:w-2/2">
          <h1 className="text-4xl font-bold mt-10 mb-8">Your Cart</h1>
          {cartItems.length === 0 ? (
            <div className="flex flex-col items-center justify-center w-full h-full">
              <p className="text-xl mb-4">Your cart is empty.</p>
              <Link to="/" className="px-6 py-3 mb-10 bg-red-500 hover:bg-red-600 rounded-full transition-colors">
                Continue Shopping
              </Link>
            </div>
          ) : (
        ...
        {cartItems.length > 0 && (
          <div className="w-1/1 lg:w-1/3 h-1/2 lg:h-1/2 bg-zinc-900 p-6 mt-11 rounded-xl lg:sticky lg:top-4">
